...
begin
  ...
  begin
    if column.Field.AsInteger >= 7 then   // condicao informando se a media for maior ou igual a 7 eu desejo q altere a cor para verde
      DBGrid2.Canvas.Brush.Color := clGreen
    else if column.Field.AsInteger <= 6 then   // condicao informando q se a media for menor ou igual a 6 eu desejo q altere a cor para vermelho
